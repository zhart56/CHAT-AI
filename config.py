...
A4F_API_URL = "https://api.a4f.co/v1" # <-- BARU
...
for directory in [WEB_CHATS_DIR, RP_CHATS_DIR, CHARACTERS_DIR, MEMORY_WEB_DIR, MEMORY_RP_DIR, TTS_CACHE_DIR, VTUBER_CHATS_DIR, CHAT_IMAGES_DIR]: # <-- TAMBAHKAN INI
